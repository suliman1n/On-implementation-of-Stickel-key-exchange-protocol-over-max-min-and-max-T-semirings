function KeyStickelsMaxMinRandomnessdetailCirculant(MaxDimension, no_trials,mm, mM,s,t)
    % Initialize arrays to store results
    D_values = 2:MaxDimension;
    ...
    for i = 1:length(D_values)
        ...
        for trial = 1:no_trials
            % Generate the matrix
            matrix = MaxminGenerateKeyStickelsCirculant(D, mm, mM, s, t);
    ...
    title('Distribution of Unique Elements and Average for Each Matrix Dimension');
